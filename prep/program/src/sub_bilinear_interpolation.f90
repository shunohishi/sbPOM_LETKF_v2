...
subroutine bilinear_interpolation_1d &
     & (im1,jm1,lon1,lat1,dat1,im2,lon2,lat2,dat2,idx,idy,rmiss)
  ...
  do i2=1,im2
     ...
     if(idx(i2) == 0 .or. idy(i2) == 0 &
        ...
        dat2(i2)=rmiss
     else if(dat1(i10,j10)==rmiss .or. dat1(i11,j10)==rmiss &
...
end subroutine bilinear_interpolation_1d
