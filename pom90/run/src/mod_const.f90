...
MODULE mod_const
  ...
  use common_pom_var, only: r_sngl, r_dble, r_size
  IMPLICIT NONE
  ...
  INTEGER, PARAMETER :: sp = r_sngl   !: single precision (real 4)
  INTEGER, PARAMETER :: dp = r_dble   !: double precision (real 8)
  INTEGER, PARAMETER :: wp = r_size   !: working precision
