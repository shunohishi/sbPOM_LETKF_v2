...
CONTAINS
   ...
   FUNCTION alfa_charn_3p0(pwnd)
      ...
      !$omp parallel
      !$omp do private(jj,ji,zw,zgt10,zgt18)
      DO jj = 1, jpj
         DO ji = 1, jpi
            !
   ...
   FUNCTION psi_m_coare( pzeta )
      ...
      !$omp parallel
      !$omp do private(jj,ji,zta,zphi_m,zpsi_k,zphi_c,zpsi_c,zf,zc,zstab)      
      DO jj = 1, jpj
         DO ji = 1, jpi
            !
            zta = pzeta(ji,jj)
   ...
   FUNCTION psi_h_coare( pzeta )
      ...
      !$omp parallel
      !$omp do private(jj,ji,zta,zphi_h,zpsi_k,zphi_c,zpsi_c,zf,zc,zstab)
      DO jj = 1, jpj
         DO ji = 1, jpi
            !
            zta = pzeta(ji,jj)
   ...
   SUBROUTINE CSWL_COARE( pTzu, pqzu, psst, pslp, pU10, pus, pts, pqs, &
      ...
      !$omp parallel
      !$omp do private(jj,ji,zdelta,zdt,zdq,zz0,zCh,zCe,zz1,zQlat,zQsen,zQlw,zfr,zQt,ztf,zalpha,zus,zz2,zlamb)      
      DO jj = 1, jpj
         DO ji = 1, jpi
