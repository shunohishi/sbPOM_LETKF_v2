module setting
  ...
  integer,parameter :: nvar2d=17,nvar3d=6,nvar_ens=5
  integer,parameter :: nvar_mlt=12,nvar_mls=12,nvar_mld=5
    
  real(kind = 8),parameter :: drho=0.125d0 !MLD criteria density [kg/m^3] 

  logical,parameter :: lqglobal=.true. !Quasi-global
  logical,parameter :: llora20=.true.  !LORA version 2.0
  ...
  !OUTPUT
  logical,parameter :: out_basic2d=.true.
  logical,parameter :: out_basic3d=.true.
  logical,parameter :: out_ensemble2d=.true.
  logical,parameter :: out_mlts2d=.true.
