program main
  ...
  !Bin (All)
  integer,allocatable :: unum_stat_bin(:,:,:),vnum_stat_bin(:,:,:),tnum_stat_bin(:,:,:)
  ...
  integer,allocatable :: unum_sprd_bin(:,:,:),vnum_sprd_bin(:,:,:),tnum_sprd_bin(:,:,:)
  real(kind = 8),allocatable :: usprd_bin(:,:,:),vsprd_bin(:,:,:),tsprd_bin(:,:,:)
  
  !Bin (Monthly)
  integer,allocatable :: unum_stat_bin_mave(:,:,:,:,:),vnum_stat_bin_mave(:,:,:,:,:),tnum_stat_bin_mave(:,:,:,:,:)
  ...
  integer,allocatable :: unum_sprd_bin_mave(:,:,:,:,:),vnum_sprd_bin_mave(:,:,:,:,:),tnum_sprd_bin_mave(:,:,:,:,:)
  ...
  !Monthly
  integer,allocatable :: unum_stat_mave(:,:,:),vnum_stat_mave(:,:,:),tnum_stat_mave(:,:,:)
  ...
  integer,allocatable :: unum_sprd_mave(:,:,:),vnum_sprd_mave(:,:,:),tnum_sprd_mave(:,:,:)
  ...
  !Yearly
  integer,allocatable :: unum_stat_yave(:,:),vnum_stat_yave(:,:),tnum_stat_yave(:,:)

  real(kind = 8),allocatable :: ubias_yave(:,:),vbias_yave(:,:),tbias_yave(:,:)
  real(kind = 8),allocatable :: urmsd_yave(:,:),vrmsd_yave(:,:),trmsd_yave(:,:)

  integer,allocatable :: unum_sprd_yave(:,:),vnum_sprd_yave(:,:),tnum_sprd_yave(:,:)  
  real(kind = 8),allocatable :: usprd_yave(:,:),vsprd_yave(:,:),tsprd_yave(:,:)

  !ALL
  integer unum_stat_ave(ndat_a),vnum_stat_ave(ndat_a),tnum_stat_ave(ndat_a)
  ...
  integer unum_sprd_ave(ndat_a),vnum_sprd_ave(ndat_a),tnum_sprd_ave(ndat_a)  
  ...
  !-Bin
  !All
  allocate(unum_stat_bin(im_bin,jm_bin,ndat_a),vnum_stat_bin(im_bin,jm_bin,ndat_a),tnum_stat_bin(im_bin,jm_bin,ndat_a))
  ...
  allocate(unum_sprd_bin(im_bin,jm_bin,ndat_a),vnum_sprd_bin(im_bin,jm_bin,ndat_a),tnum_sprd_bin(im_bin,jm_bin,ndat_a))  
  allocate(usprd_bin(im_bin,jm_bin,ndat_a),vsprd_bin(im_bin,jm_bin,ndat_a),tsprd_bin(im_bin,jm_bin,ndat_a))

  !Month
  allocate(unum_stat_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr),vnum_stat_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr),tnum_stat_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr))
  ...
  allocate(unum_sprd_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr),vnum_sprd_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr),tnum_sprd_bin_mave(im_bin,jm_bin,ndat_a,12,syr:eyr))
  ...
  !-Ave
  !Month
  allocate(unum_stat_mave(ndat_a,12,syr:eyr),vnum_stat_mave(ndat_a,12,syr:eyr),tnum_stat_mave(ndat_a,12,syr:eyr))
  ...
  allocate(unum_sprd_mave(ndat_a,12,syr:eyr),vnum_sprd_mave(ndat_a,12,syr:eyr),tnum_sprd_mave(ndat_a,12,syr:eyr))
  allocate(usprd_mave(ndat_a,12,syr:eyr),vsprd_mave(ndat_a,12,syr:eyr),tsprd_mave(ndat_a,12,syr:eyr))

  !Year
  allocate(unum_stat_yave(ndat_a,syr:eyr),vnum_stat_yave(ndat_a,syr:eyr),tnum_stat_yave(ndat_a,syr:eyr))
  ...
  allocate(unum_sprd_yave(ndat_a,syr:eyr),vnum_sprd_yave(ndat_a,syr:eyr),tnum_sprd_yave(ndat_a,syr:eyr))
  allocate(usprd_yave(ndat_a,syr:eyr),vsprd_yave(ndat_a,syr:eyr),tsprd_yave(ndat_a,syr:eyr))

  !---Initialization
  do idat_a=1,ndat_a
     !Bias & RMSD
     call stat_bin_ini(im_bin,jm_bin,unum_stat_bin(:,:,idat_a),ubias_bin(:,:,idat_a),urmsd_bin(:,:,idat_a))
     call stat_bin_ini(im_bin,jm_bin,vnum_stat_bin(:,:,idat_a),vbias_bin(:,:,idat_a),vrmsd_bin(:,:,idat_a))
     call stat_bin_ini(im_bin,jm_bin,tnum_stat_bin(:,:,idat_a),tbias_bin(:,:,idat_a),trmsd_bin(:,:,idat_a))
     !Spread
     call sprd_bin_ini(im_bin,jm_bin,unum_sprd_bin(:,:,idat_a),usprd_bin(:,:,idat_a))
     call sprd_bin_ini(im_bin,jm_bin,vnum_sprd_bin(:,:,idat_a),vsprd_bin(:,:,idat_a))
     call sprd_bin_ini(im_bin,jm_bin,tnum_sprd_bin(:,:,idat_a),tsprd_bin(:,:,idat_a))
  end do!idat_a
  ...
  do iyr=syr,eyr
     ...
     do idat_a=1,ndat_a
        !Bias & RMSD
        call stat_ave_ini(unum_stat_yave(idat_a,iyr),ubias_yave(idat_a,iyr),urmsd_yave(idat_a,iyr))
        call stat_ave_ini(vnum_stat_yave(idat_a,iyr),vbias_yave(idat_a,iyr),vrmsd_yave(idat_a,iyr))
        call stat_ave_ini(tnum_stat_yave(idat_a,iyr),tbias_yave(idat_a,iyr),trmsd_yave(idat_a,iyr))
        !Spread
        call sprd_ave_ini(unum_sprd_yave(idat_a,iyr),usprd_yave(idat_a,iyr))
        call sprd_ave_ini(vnum_sprd_yave(idat_a,iyr),vsprd_yave(idat_a,iyr))
        call sprd_ave_ini(tnum_sprd_yave(idat_a,iyr),tsprd_yave(idat_a,iyr))
     end do !idat_a
     ...
     do imon=1,12
        do idat_a=1,ndat_a
           ...
           call stat_bin_ini(im_bin,jm_bin, &
                & unum_stat_bin_mave(:,:,idat_a,imon,iyr),ubias_bin_mave(:,:,idat_a,imon,iyr),urmsd_bin_mave(:,:,idat_a,imon,iyr))
           call stat_bin_ini(im_bin,jm_bin, &
                & vnum_stat_bin_mave(:,:,idat_a,imon,iyr),vbias_bin_mave(:,:,idat_a,imon,iyr),vrmsd_bin_mave(:,:,idat_a,imon,iyr))
           call stat_bin_ini(im_bin,jm_bin, &
                & tnum_stat_bin_mave(:,:,idat_a,imon,iyr),tbias_bin_mave(:,:,idat_a,imon,iyr),trmsd_bin_mave(:,:,idat_a,imon,iyr))     
           !Spread (Bin)
           call sprd_bin_ini(im_bin,jm_bin, &
                & unum_sprd_bin_mave(:,:,idat_a,imon,iyr),usprd_bin_mave(:,:,idat_a,imon,iyr))
           call sprd_bin_ini(im_bin,jm_bin, &
                & vnum_sprd_bin_mave(:,:,idat_a,imon,iyr),vsprd_bin_mave(:,:,idat_a,imon,iyr))
           call sprd_bin_ini(im_bin,jm_bin, &
                & tnum_sprd_bin_mave(:,:,idat_a,imon,iyr),tsprd_bin_mave(:,:,idat_a,imon,iyr))

           !Bias & RMSD
           call stat_ave_ini(unum_stat_mave(idat_a,imon,iyr),ubias_mave(idat_a,imon,iyr),urmsd_mave(idat_a,imon,iyr))
           call stat_ave_ini(vnum_stat_mave(idat_a,imon,iyr),vbias_mave(idat_a,imon,iyr),vrmsd_mave(idat_a,imon,iyr))
           call stat_ave_ini(tnum_stat_mave(idat_a,imon,iyr),tbias_mave(idat_a,imon,iyr),trmsd_mave(idat_a,imon,iyr))
           !Spread
           call sprd_ave_ini(unum_sprd_mave(idat_a,imon,iyr),usprd_mave(idat_a,imon,iyr))
           call sprd_ave_ini(vnum_sprd_mave(idat_a,imon,iyr),vsprd_mave(idat_a,imon,iyr))
           call sprd_ave_ini(tnum_sprd_mave(idat_a,imon,iyr),tsprd_mave(idat_a,imon,iyr))
  ...
  do idat_a=1,ndat_a
     !Bias & RMSD
     call stat_ave_ini(unum_stat_ave(idat_a),ubias_ave(idat_a),urmsd_ave(idat_a))
     call stat_ave_ini(vnum_stat_ave(idat_a),vbias_ave(idat_a),vrmsd_ave(idat_a))
     call stat_ave_ini(tnum_stat_ave(idat_a),tbias_ave(idat_a),trmsd_ave(idat_a))
     !Spread
     call sprd_ave_ini(unum_sprd_ave(idat_a),usprd_ave(idat_a))
     call sprd_ave_ini(vnum_sprd_ave(idat_a),vsprd_ave(idat_a))
     call sprd_ave_ini(tnum_sprd_ave(idat_a),tsprd_ave(idat_a))
  end do
  ...
  do idat_a=1,ndat_a
     ...
     do ijul=sjul,ejul
        ...
        write(*,*) "Valdation"
        !Bin(All)
        call stat_bin_add(nobs,lon_o,lat_o,hu_a,u_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & unum_stat_bin(:,:,idat_a),ubias_bin(:,:,idat_a),urmsd_bin(:,:,idat_a))
        call stat_bin_add(nobs,lon_o,lat_o,hv_a,v_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & vnum_stat_bin(:,:,idat_a),vbias_bin(:,:,idat_a),vrmsd_bin(:,:,idat_a))
        call stat_bin_add(nobs,lon_o,lat_o,ht_a,t_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & tnum_stat_bin(:,:,idat_a),tbias_bin(:,:,idat_a),trmsd_bin(:,:,idat_a))

        call sprd_bin_add(nobs,lon_o,lat_o,husprd_a,u_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & unum_sprd_bin(:,:,idat_a),usprd_bin(:,:,idat_a))
        call sprd_bin_add(nobs,lon_o,lat_o,hvsprd_a,v_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & vnum_sprd_bin(:,:,idat_a),vsprd_bin(:,:,idat_a))
        call sprd_bin_add(nobs,lon_o,lat_o,htsprd_a,t_o, &
             & im_bin,jm_bin,lon_bin,lat_bin, &
             & tnum_sprd_bin(:,:,idat_a),tsprd_bin(:,:,idat_a))
        ...
        !Monthly
        call stat_ave_add(nobs,hu_a,u_o, &
             & unum_stat_mave(idat_a,imon,iyr),ubias_mave(idat_a,imon,iyr),urmsd_mave(idat_a,imon,iyr))
        call stat_ave_add(nobs,hv_a,v_o, &
             & vnum_stat_mave(idat_a,imon,iyr),vbias_mave(idat_a,imon,iyr),vrmsd_mave(idat_a,imon,iyr))
        call stat_ave_add(nobs,ht_a,t_o, &
             & tnum_stat_mave(idat_a,imon,iyr),tbias_mave(idat_a,imon,iyr),trmsd_mave(idat_a,imon,iyr))

        call sprd_ave_add(nobs,husprd_a,u_o, &
             & unum_sprd_mave(idat_a,imon,iyr),usprd_mave(idat_a,imon,iyr))
        call sprd_ave_add(nobs,hvsprd_a,v_o, &
             & vnum_sprd_mave(idat_a,imon,iyr),vsprd_mave(idat_a,imon,iyr))
        call sprd_ave_add(nobs,htsprd_a,t_o, &
             & tnum_sprd_mave(idat_a,imon,iyr),tsprd_mave(idat_a,imon,iyr))
        
        !Yearly
        call stat_ave_add(nobs,hu_a,u_o, &
             & unum_stat_yave(idat_a,iyr),ubias_yave(idat_a,iyr),urmsd_yave(idat_a,iyr))
        call stat_ave_add(nobs,hv_a,v_o, &
             & vnum_stat_yave(idat_a,iyr),vbias_yave(idat_a,iyr),vrmsd_yave(idat_a,iyr))
        call stat_ave_add(nobs,ht_a,t_o, &
             & tnum_stat_yave(idat_a,iyr),tbias_yave(idat_a,iyr),trmsd_yave(idat_a,iyr))

        call sprd_ave_add(nobs,husprd_a,u_o, &
             & unum_sprd_yave(idat_a,iyr),usprd_yave(idat_a,iyr))
        call sprd_ave_add(nobs,hvsprd_a,v_o, &
             & vnum_sprd_yave(idat_a,iyr),vsprd_yave(idat_a,iyr))
        call sprd_ave_add(nobs,htsprd_a,t_o, &
             & tnum_sprd_yave(idat_a,iyr),tsprd_yave(idat_a,iyr))

        !ALL
        call stat_ave_add(nobs,hu_a,u_o, &
             & unum_stat_ave(idat_a),ubias_ave(idat_a),urmsd_ave(idat_a))
        call stat_ave_add(nobs,hv_a,v_o, &
             & vnum_stat_ave(idat_a),vbias_ave(idat_a),vrmsd_ave(idat_a))
        call stat_ave_add(nobs,ht_a,t_o, &
             & tnum_stat_ave(idat_a),tbias_ave(idat_a),trmsd_ave(idat_a))

        call sprd_ave_add(nobs,husprd_a,u_o, &
             & unum_sprd_ave(idat_a),usprd_ave(idat_a))
        call sprd_ave_add(nobs,hvsprd_a,v_o, &
             & vnum_sprd_ave(idat_a),vsprd_ave(idat_a))
        call sprd_ave_add(nobs,htsprd_a,t_o, &
             & tnum_sprd_ave(idat_a),tsprd_ave(idat_a))
  ...
  do idat_a=1,ndat_a
     ...
     call sprd_bin_end(im_bin,jm_bin, &
          & unum_sprd_bin(:,:,idat_a),usprd_bin(:,:,idat_a))
     call sprd_bin_end(im_bin,jm_bin, &
          & vnum_sprd_bin(:,:,idat_a),vsprd_bin(:,:,idat_a))
     call sprd_bin_end(im_bin,jm_bin, &
  ...
  do iyr=syr,eyr
     ...
     do idat_a=1,ndat_a
        ...
        call stat_ave_end(unum_stat_yave(idat_a,iyr),ubias_yave(idat_a,iyr),urmsd_yave(idat_a,iyr))
        call stat_ave_end(vnum_stat_yave(idat_a,iyr),vbias_yave(idat_a,iyr),vrmsd_yave(idat_a,iyr))
        call stat_ave_end(tnum_stat_yave(idat_a,iyr),tbias_yave(idat_a,iyr),trmsd_yave(idat_a,iyr))

        call sprd_ave_end(unum_sprd_yave(idat_a,iyr),usprd_yave(idat_a,iyr))
        call sprd_ave_end(vnum_sprd_yave(idat_a,iyr),vsprd_yave(idat_a,iyr))
        call sprd_ave_end(tnum_sprd_yave(idat_a,iyr),tsprd_yave(idat_a,iyr))
     ...
     do imon=1,12
        do idat_a=1,ndat_a
           ...
           call stat_ave_end(unum_stat_mave(idat_a,imon,iyr),ubias_mave(idat_a,imon,iyr),urmsd_mave(idat_a,imon,iyr))
           call stat_ave_end(vnum_stat_mave(idat_a,imon,iyr),vbias_mave(idat_a,imon,iyr),vrmsd_mave(idat_a,imon,iyr))
           call stat_ave_end(tnum_stat_mave(idat_a,imon,iyr),tbias_mave(idat_a,imon,iyr),trmsd_mave(idat_a,imon,iyr))

           call sprd_ave_end(unum_sprd_mave(idat_a,imon,iyr),usprd_mave(idat_a,imon,iyr))
           call sprd_ave_end(vnum_sprd_mave(idat_a,imon,iyr),vsprd_mave(idat_a,imon,iyr))
           call sprd_ave_end(tnum_sprd_mave(idat_a,imon,iyr),tsprd_mave(idat_a,imon,iyr))
  ...
  do idat_a=1,ndat_a
     ...
     call stat_ave_end(unum_stat_ave(idat_a),ubias_ave(idat_a),urmsd_ave(idat_a))
     call stat_ave_end(vnum_stat_ave(idat_a),vbias_ave(idat_a),vrmsd_ave(idat_a))
     call stat_ave_end(tnum_stat_ave(idat_a),tbias_ave(idat_a),trmsd_ave(idat_a))

     call sprd_ave_end(unum_sprd_ave(idat_a),usprd_ave(idat_a))
     call sprd_ave_end(vnum_sprd_ave(idat_a),vsprd_ave(idat_a))
     call sprd_ave_end(tnum_sprd_ave(idat_a),tsprd_ave(idat_a))
