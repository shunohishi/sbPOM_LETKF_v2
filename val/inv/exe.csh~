...
set module="../module/mod_julian.f90 ../module/mod_rmiss.f90 ../module/mod_read_db.f90 ../module/mod_gridinfo.f90 ../module/mod_bin.f90 ../module/mod_static.f90 ../module/mod_read_lora.f90"
set subroutine="sub_bilinear_interpolation.f90 sub_cal_id.f90 sub_io.f90"
