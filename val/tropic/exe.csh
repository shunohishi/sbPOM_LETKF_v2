...
set module="../module/mod_julian.f90 ../module/mod_rmiss.f90 ../module/mod_gridinfo.f90 ../module/mod_read_lora_v20.f90 ../module/mod_read_glorys025.f90"
set subroutine="sub_index.f90 sub_io.f90 sub_nday.f90"
