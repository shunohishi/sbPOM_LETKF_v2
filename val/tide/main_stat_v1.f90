program main
  ...
  !Paired t-test
  integer bias_dof_ave(nst,ndat_a,ndat_a)
  integer rmsd_dof_ave(nst,ndat_a,ndat_a)

  real(kind = 8) bias_tcrit_ave(nst,ndat_a,ndat_a),bias_tval_ave(nst,ndat_a,ndat_a)
  real(kind = 8) rmsd_tcrit_ave(nst,ndat_a,ndat_a),rmsd_tval_ave(nst,ndat_a,ndat_a)

  integer bias_dof_ave_all(ndat_a,ndat_a)
  integer rmsd_dof_ave_all(ndat_a,ndat_a)
  
  real(kind = 8) bias_tcrit_ave_all(ndat_a,ndat_a),bias_tval_ave_all(ndat_a,ndat_a)
  real(kind = 8) rmsd_tcrit_ave_all(ndat_a,ndat_a),rmsd_tval_ave_all(ndat_a,ndat_a)
  ...
  do ist=1,nst        
     ...
     !Initialize
     call substitute_rmiss(ndat_a,bias_dof_ave(ist,:,:),bias_tcrit_ave(ist,:,:),bias_tval_ave(ist,:,:))
     call substitute_rmiss(ndat_a,rmsd_dof_ave(ist,:,:),rmsd_tcrit_ave(ist,:,:),rmsd_tval_ave(ist,:,:))     
     ...
     do idat_a=1,ndat_a
        do jdat_a=1,ndat_a
           ...
           !Bias
           call paired_t_test((eyr-syr+1)*12,abias_mave(ist,idat_a,:,syr:eyr),abias_mave(ist,jdat_a,:,syr:eyr), &
                & bias_dof_ave(ist,idat_a,jdat_a),bias_tcrit_ave(ist,idat_a,jdat_a),bias_tval_ave(ist,idat_a,jdat_a))

           !RMSD
           call paired_t_test((eyr-syr+1)*12,rmsd_mave(ist,idat_a,:,syr:eyr),rmsd_mave(ist,jdat_a,:,syr:eyr), &
                & rmsd_dof_ave(ist,idat_a,jdat_a),rmsd_tcrit_ave(ist,idat_a,jdat_a),rmsd_tval_ave(ist,idat_a,jdat_a))
  ...
  !Initialize
  call substitute_rmiss(ndat_a,bias_dof_ave_all,bias_tcrit_ave_all,bias_tval_ave_all)
  call substitute_rmiss(ndat_a,rmsd_dof_ave_all,rmsd_tcrit_ave_all,rmsd_tval_ave_all)
  ...
  do idat_a=1,ndat_a
     do jdat_a=1,ndat_a
        ...
        !Bias
        call paired_t_test((eyr-syr+1)*12,abias_mave_all(idat_a,:,syr:eyr),abias_mave_all(jdat_a,:,syr:eyr), &
             & bias_dof_ave_all(idat_a,jdat_a),bias_tcrit_ave_all(idat_a,jdat_a),bias_tval_ave_all(idat_a,jdat_a))
        
        !RMSD
        call paired_t_test((eyr-syr+1)*12,rmsd_mave_all(idat_a,:,syr:eyr),rmsd_mave_all(jdat_a,:,syr:eyr), &
             & rmsd_dof_ave_all(idat_a,jdat_a),rmsd_tcrit_ave_all(idat_a,jdat_a),rmsd_tval_ave_all(idat_a,jdat_a))
  ...
  call write_stat_ave(nst,ndat_a,lon_o_ave,lat_o_ave, &
       ...
       & bias_dof_ave,bias_tcrit_ave,bias_tval_ave, &
       & rmsd_dof_ave,rmsd_tcrit_ave,rmsd_tval_ave)
  call write_stat_ave_all(ndat_a,bias_ave_all,rmsd_ave_all,sprd_ave_all, &
       & bias_dof_ave_all,bias_tcrit_ave_all,bias_tval_ave_all, &
       & rmsd_dof_ave_all,rmsd_tcrit_ave_all,rmsd_tval_ave_all)
