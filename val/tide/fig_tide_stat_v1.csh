...
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $9 != -999 && $9-$8 <= 0. && $13*$13 <= $17*$17) print $2,$3,100*($9-$8)/$8 > "sig2.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $9 != -999 && $9-$8 > 0. && $13*$13 <= $17*$17) print $2,$3,100*($9-$8)/$8 >> "sig2.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $10 != -999 && $9-$8 <= 0. && $14*$14 <= $18*$18) print $2,$3,100*($10-$8)/$8 > "sig3.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $10 != -999 && $9-$8 > 0. && $14*$14 <= $18*$18) print $2,$3,100*($10-$8)/$8 >> "sig3.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $11 != -999 && $9-$8 <= 0. && $15*$15 <= $19*$19) print $2,$3,100*($11-$8)/$8 > "sig4.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $11 != -999 && $9-$8 > 0. && $15*$15 <= $19*$19) print $2,$3,100*($11-$8)/$8 >> "sig4.20"}' ${input}

gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $9 != -999 && $9-$8 <= 0. && $13*$13 > $17*$17) print $2,$3,100*($9-$8)/$8 > "nosig2.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $9 != -999 && $9-$8 > 0. && $13*$13 > $17*$17) print $2,$3,100*($9-$8)/$8 >> "nosig2.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $10 != -999 && $10-$8 <= 0. && $14*$14 > $18*$18) print $2,$3,100*($10-$8)/$8 > "nosig3.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $10 != -999 && $10-$8 > 0. && $14*$14 > $18*$18) print $2,$3,100*($10-$8)/$8 >> "nosig3.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $11 != -999 && $11-$8 <= 0. && $15*$15 > $19*$19) print $2,$3,100*($11-$8)/$8 > "nosig4.20"}' ${input}
gawk -v nobs=${nobs} \
'{if(nobs < $4 && $8 != -999 && $11 != -999 && $11-$8 > 0. && $15*$15 > $19*$19) print $2,$3,100*($11-$8)/$8 >> "nosig4.20"}' ${input}
...
gawk '{if($6*$6 < $10*$10) print 3 > "rmsd2_ave_sig.20"; else print 0 > "rmsd2_ave_sig.20"}' ${input} 
gawk '{if($7*$7 < $11*$11) print 3 > "rmsd3_ave_sig.20"; else print 0 > "rmsd3_ave_sig.20"}' ${input} 
gawk '{if($8*$8 < $12*$12) print 3 > "rmsd4_ave_sig.20"; else print 0 > "rmsd4_ave_sig.20"}' ${input} 
